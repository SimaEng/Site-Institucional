const basePath = window.location.pathname.startsWith("/Site-Institucional") ? "/Site-Institucional" : "";
const articles = [
  {
        ...
        <div class="client-contact-grid">
          ...
          <aside class="contact-info-panel contact-info-client reveal">
            ...
            <div>
              ...
              <address style="margin-bottom: 12px;">Rua Ouvidor Peleja nº 772<br>Vila Mariana — São Paulo / SP — Brasil</address>
              <a href="https://maps.app.goo.gl/kX7HZYDkRByb4hZ77" target="_blank" rel="noopener noreferrer" class="text-link" style="display: inline-flex; padding: 6px 14px; min-height: 0; font-size: 0.8rem;">Ver no Mapa <i class="ri-map-pin-line" aria-hidden="true"></i></a>
            </div>
          </aside>
        </div>
